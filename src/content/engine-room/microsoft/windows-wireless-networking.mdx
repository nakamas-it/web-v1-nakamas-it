...
tags: ["windows", "wireless", "wifi", "wpa3", "802.11", "md-100"]
order: 84
draft: false
---
...
For administrators, understanding the 802.11 standards and their frequency characteristics is necessary for diagnosing performance issues and advising on hardware selection. Understanding the wireless security standards is essential for configuring corporate networks correctly and for the MD-100 exam.
